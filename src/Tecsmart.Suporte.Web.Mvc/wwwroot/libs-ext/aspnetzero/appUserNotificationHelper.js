...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Tecsmart.Epm.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                ...
                var customUrl = userNotification.notification.data.properties.Url;
                if (customUrl == null) {
                    return '#';
                } else {
                    return customUrl;
