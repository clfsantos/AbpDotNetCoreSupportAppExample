...
{
    public partial class Add_FilaRetornos : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "spchamado_fila_retornos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    FilaAtendimentoId = table.Column<int>(type: "integer", nullable: false),
                    TipoRetorno = table.Column<int>(type: "integer", nullable: false),
                    DataRetorno = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Observacao = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_fila_retornos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_spchamado_fila_retornos_spchamado_fila_FilaAtendimentoId",
                        column: x => x.FilaAtendimentoId,
                        principalTable: "spchamado_fila",
                        principalColumn: "spchamado_fila_id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_fila_retornos_FilaAtendimentoId",
