...
namespace Tecsmart.Suporte.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    crcliente_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    crcliente_cnpj = table.Column<string>(type: "varchar(14)", maxLength: 14, nullable: false),
                    crcliente_fantasia = table.Column<string>(type: "varchar(256)", nullable: false),
                    crcliente_razao = table.Column<string>(type: "varchar(256)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_crcliente", x => x.crcliente_id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "spchamado_class",
                columns: table => new
                {
                    spchamado_class_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_class_desc = table.Column<string>(type: "varchar(60)", nullable: false),
                    spchamado_class_obs = table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_class", x => x.spchamado_class_id);
                });

            migrationBuilder.CreateTable(
                name: "spchamado_grupo",
                columns: table => new
                {
                    spchamado_grupo_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_grupo_desc = table.Column<string>(type: "varchar(60)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_grupo", x => x.spchamado_grupo_id);
                });

            migrationBuilder.CreateTable(
                name: "spchamado_origem",
                columns: table => new
                {
                    spchamado_origem_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_origem_desc = table.Column<string>(type: "varchar(60)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_origem", x => x.spchamado_origem_id);
                });

            migrationBuilder.CreateTable(
                name: "spchamado_produto",
                columns: table => new
                {
                    spchamado_produto_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_produto_desc = table.Column<string>(type: "varchar(60)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_produto", x => x.spchamado_produto_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    spchamado_sla_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_sla_desc = table.Column<string>(type: "varchar(60)", nullable: false),
                    spchamado_sla_time = table.Column<TimeSpan>(type: "interval", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_sla", x => x.spchamado_sla_id);
                });

            migrationBuilder.CreateTable(
                name: "spchamado_subgrupo",
                columns: table => new
                {
                    spchamado_subgrupo_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_subgrupo_desc = table.Column<string>(type: "varchar(60)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_subgrupo", x => x.spchamado_subgrupo_id);
                });

            migrationBuilder.CreateTable(
                name: "spimplantacao_etapa_status",
                columns: table => new
                {
                    etapa_status_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    etapa_status_desc = table.Column<string>(type: "varchar(60)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spimplantacao_etapa_status", x => x.etapa_status_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    spfollowup_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spfollowup_tipo = table.Column<int>(type: "integer", nullable: false),
                    spfollowup_dt = table.Column<DateTime>(type: "timestamp", nullable: false),
                    spfollowup_conteudo = table.Column<string>(type: "text", nullable: false),
                    spfollowup_usuario_id = table.Column<int>(type: "integer", nullable: false),
                    spfollowup_usuario_trans = table.Column<int>(type: "integer", nullable: true),
                    cancelado = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spfollowup", x => x.spfollowup_id);
                    table.ForeignKey(
                        name: "FK_spfollowup_AbpUsers_spfollowup_usuario_id",
                        column: x => x.spfollowup_usuario_id,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spfollowup_AbpUsers_spfollowup_usuario_trans",
                        column: x => x.spfollowup_usuario_trans,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                name: "spimplantacao_etapa",
                columns: table => new
                {
                    etapa_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    etapa_seq = table.Column<int>(type: "integer", nullable: false),
                    etapa_desc = table.Column<string>(type: "varchar(256)", nullable: false),
                    etapa_resp = table.Column<int>(type: "integer", nullable: false),
                    setor_resp = table.Column<string>(type: "varchar(256)", nullable: true),
                    etapa_obs = table.Column<string>(type: "text", nullable: true),
                    etapa_hrs = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spimplantacao_etapa", x => x.etapa_id);
                    table.ForeignKey(
                        name: "FK_spimplantacao_etapa_AbpUsers_etapa_resp",
                        column: x => x.etapa_resp,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    spchamado_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_dt_abertura = table.Column<DateTime>(type: "timestamp", nullable: false),
                    spchamado_cliente_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_contato = table.Column<string>(type: "varchar(60)", nullable: false),
                    spchamado_financeiro = table.Column<bool>(type: "boolean", nullable: false),
                    spchamado_osrel = table.Column<int>(type: "integer", nullable: true),
                    spchamado_origem_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_class_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_produto_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_grupo_id = table.Column<int>(type: "integer", nullable: true),
                    spchamado_subgrupo_id = table.Column<int>(type: "integer", nullable: true),
                    spchamado_ocorrencia = table.Column<string>(type: "text", nullable: false),
                    spchamado_responsavel_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_resp_atual_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_sla_prioridade_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_sla_data_vto = table.Column<DateTime>(type: "timestamp", nullable: false),
                    spchamado_dt_encerramento = table.Column<DateTime>(type: "timestamp", nullable: true),
                    spchamado_status = table.Column<int>(type: "integer", nullable: true),
                    spchamado_resp_fechamento_id = table.Column<int>(type: "integer", nullable: true),
                    spchamado_release_id = table.Column<int>(type: "integer", nullable: true),
                    spchamado_resolver = table.Column<string>(type: "text", nullable: true),
                    spchamado_aberto = table.Column<bool>(type: "boolean", nullable: false),
                    spchamado_cancelado = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado", x => x.spchamado_id);
                    table.ForeignKey(
                        name: "FK_spchamado_AbpUsers_spchamado_resp_atual_id",
                        column: x => x.spchamado_resp_atual_id,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_AbpUsers_spchamado_resp_fechamento_id",
                        column: x => x.spchamado_resp_fechamento_id,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_spchamado_AbpUsers_spchamado_responsavel_id",
                        column: x => x.spchamado_responsavel_id,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_crcliente_spchamado_cliente_id",
                        column: x => x.spchamado_cliente_id,
            ...
            migrationBuilder.CreateTable(
                name: "spchamado_fluxo",
                columns: table => new
                {
                    spchamado_fluxo_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    usuario_id = table.Column<int>(type: "integer", nullable: false),
                    crcliente_id = table.Column<int>(type: "integer", nullable: false),
                    spchamado_fluxo_dt = table.Column<DateTime>(type: "timestamp", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_fluxo", x => x.spchamado_fluxo_id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_fluxo_crcliente_crcliente_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_produto_grupo", x => new { x.spchamado_produto_id, x.spchamado_grupo_id });
                    table.ForeignKey(
                        name: "FK_spchamado_produto_grupo_spchamado_grupo_spchamado_grupo_id",
                        column: x => x.spchamado_grupo_id,
                        principalTable: "spchamado_grupo",
                        principalColumn: "spchamado_grupo_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_produto_grupo_spchamado_produto_spchamado_produto~",
                        column: x => x.spchamado_produto_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_grupo_subgrupo", x => new { x.spchamado_grupo_id, x.spchamado_subgrupo_id });
                    table.ForeignKey(
                        name: "FK_spchamado_grupo_subgrupo_spchamado_grupo_spchamado_grupo_id",
                        column: x => x.spchamado_grupo_id,
                        principalTable: "spchamado_grupo",
                        principalColumn: "spchamado_grupo_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_grupo_subgrupo_spchamado_subgrupo_spchamado_subgr~",
                        column: x => x.spchamado_subgrupo_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    spanexo_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_id = table.Column<int>(type: "integer", nullable: false),
                    spanexo_nome = table.Column<string>(type: "varchar(255)", nullable: false),
                    spanexo_caminho = table.Column<string>(type: "varchar(255)", nullable: false),
                    spanexo_dt_up = table.Column<DateTime>(type: "timestamp", nullable: false),
                    spanexo_usuario = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spanexo", x => x.spanexo_id);
                    table.ForeignKey(
                        name: "FK_spanexo_AbpUsers_spanexo_usuario",
                        column: x => x.spanexo_usuario,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spanexo_spchamado_spchamado_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_spchamado_followup", x => new { x.spchamado_id, x.spfollowup_id });
                    table.ForeignKey(
                        name: "FK_spchamado_followup_spchamado_spchamado_id",
                        column: x => x.spchamado_id,
                        principalTable: "spchamado",
                        principalColumn: "spchamado_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spchamado_followup_spfollowup_spfollowup_id",
                        column: x => x.spfollowup_id,
                        principalTable: "spfollowup",
                        principalColumn: "spfollowup_id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "spimplantacao_etapa_chamado",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    ...
                    etapa_status_id = table.Column<int>(type: "integer", nullable: false),
                    etapa_obs = table.Column<string>(type: "text", nullable: true),
                    etapa_dt = table.Column<DateTime>(type: "timestamp", nullable: true),
                    etapa_dt_conclusao = table.Column<DateTime>(type: "timestamp", nullable: true),
                    etapa_obs_recusada = table.Column<string>(type: "text", nullable: true),
                    etapa_dt_recusada = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_spimplantacao_etapa_chamado", x => x.id);
                    table.ForeignKey(
                        name: "FK_spimplantacao_etapa_chamado_spchamado_spchamado_id",
                        column: x => x.spchamado_id,
                        principalTable: "spchamado",
                        principalColumn: "spchamado_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spimplantacao_etapa_chamado_spimplantacao_etapa_etapa_id",
                        column: x => x.etapa_id,
                        principalTable: "spimplantacao_etapa",
                        principalColumn: "etapa_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_spimplantacao_etapa_chamado_spimplantacao_etapa_status_etap~",
                        column: x => x.etapa_status_id,
                        principalTable: "spimplantacao_etapa_status",
                        principalColumn: "etapa_status_id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    sptarefa_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    spchamado_id = table.Column<int>(type: "integer", nullable: false),
                    sptarefa_status = table.Column<bool>(type: "boolean", nullable: false),
                    sptarefa_duracao = table.Column<TimeSpan>(type: "time", nullable: false),
                    sptarefa_dt_tarefa = table.Column<DateTime>(type: "timestamp", nullable: false),
                    sptarefa_dt_vto = table.Column<DateTime>(type: "timestamp", nullable: false),
                    sptarefa_titulo = table.Column<string>(type: "varchar(60)", nullable: false),
                    sptarefa_desc = table.Column<string>(type: "text", nullable: false),
                    sptarefa_usuario = table.Column<int>(type: "integer", nullable: false),
                    sptarefa_u_atribuido = table.Column<int>(type: "integer", nullable: true),
                    sptarefa_cancelada = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_sptarefa", x => x.sptarefa_id);
                    table.ForeignKey(
                        name: "FK_sptarefa_AbpUsers_sptarefa_u_atribuido",
                        column: x => x.sptarefa_u_atribuido,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_sptarefa_AbpUsers_sptarefa_usuario",
                        column: x => x.sptarefa_usuario,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_sptarefa_spchamado_spchamado_id",
                        column: x => x.spchamado_id,
                        principalTable: "spchamado",
                        principalColumn: "spchamado_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_spanexo_spanexo_usuario",
                table: "spanexo",
                column: "spanexo_usuario");

            migrationBuilder.CreateIndex(
                name: "IX_spanexo_spchamado_id",
                table: "spanexo",
                column: "spchamado_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_spchamado_cliente_id",
                table: "spchamado",
                column: "spchamado_cliente_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_spchamado_resp_atual_id",
                table: "spchamado",
                column: "spchamado_resp_atual_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_spchamado_resp_fechamento_id",
                table: "spchamado",
                column: "spchamado_resp_fechamento_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_spchamado_responsavel_id",
                table: "spchamado",
                column: "spchamado_responsavel_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_fluxo_crcliente_id",
                table: "spchamado_fluxo",
                column: "crcliente_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_fluxo_usuario_id",
                table: "spchamado_fluxo",
                column: "usuario_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_followup_spfollowup_id",
                table: "spchamado_followup",
                column: "spfollowup_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_grupo_subgrupo_spchamado_subgrupo_id",
                table: "spchamado_grupo_subgrupo",
                column: "spchamado_subgrupo_id");

            migrationBuilder.CreateIndex(
                name: "IX_spchamado_produto_grupo_spchamado_grupo_id",
                table: "spchamado_produto_grupo",
                column: "spchamado_grupo_id");

            migrationBuilder.CreateIndex(
                name: "IX_spfollowup_spfollowup_usuario_id",
                table: "spfollowup",
                column: "spfollowup_usuario_id");

            migrationBuilder.CreateIndex(
                name: "IX_spfollowup_spfollowup_usuario_trans",
                table: "spfollowup",
                column: "spfollowup_usuario_trans");

            migrationBuilder.CreateIndex(
                name: "IX_spimplantacao_etapa_etapa_resp",
                table: "spimplantacao_etapa",
                column: "etapa_resp");

            migrationBuilder.CreateIndex(
                name: "IX_spimplantacao_etapa_chamado_etapa_id",
                table: "spimplantacao_etapa_chamado",
                column: "etapa_id");

            migrationBuilder.CreateIndex(
                name: "IX_spimplantacao_etapa_chamado_etapa_status_id",
                table: "spimplantacao_etapa_chamado",
                column: "etapa_status_id");

            migrationBuilder.CreateIndex(
                name: "IX_spimplantacao_etapa_chamado_spchamado_id",
                table: "spimplantacao_etapa_chamado",
                column: "spchamado_id");

            migrationBuilder.CreateIndex(
                name: "IX_sptarefa_spchamado_id",
                table: "sptarefa",
                column: "spchamado_id");

            migrationBuilder.CreateIndex(
                name: "IX_sptarefa_sptarefa_u_atribuido",
                table: "sptarefa",
                column: "sptarefa_u_atribuido");

            migrationBuilder.CreateIndex(
                name: "IX_sptarefa_sptarefa_usuario",
                table: "sptarefa",
