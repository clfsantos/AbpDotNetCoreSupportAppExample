...
{
    public abstract class SuporteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SuporteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SuporteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SuporteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SuporteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SuporteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SuporteDbContext, Task<T>> func)
        {
            T result;
